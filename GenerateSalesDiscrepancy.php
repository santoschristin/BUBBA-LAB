...
$message=NULL;
 ...
 if (empty($_POST['startDate'])){
  ...
  $message.='<p>You forgot to enter the Start Date!';
 } else {
 ...
 if (empty($_POST['endDate'])){
  ...
  $message.='<p>You forgot to enter the End Date!';
 } else {
  $_SESSION['endDate']=$_POST['endDate']; 
       ...
       header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/SalesDiscrepancyReport.php");
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Generate Sales Discrepancy Report</h3>
              </div>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="startdate" name="startDate" value="<?php if (isset($_POST['startDate'])) echo $_POST['startDate']; ?>" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="enddate" name="endDate" value="<?php if (isset($_POST['endDate'])) echo $_POST['endDate']; ?>" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                        </div>
                      </div>
