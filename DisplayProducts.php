				 ...
				 <div align="right">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$prodsize = array();
						$prodprice = array();
						$qgetproducts = "SELECT * FROM PRODUCTS";
						$rungetproducts = mysqli_query($dbc, $qgetproducts);
	
						

						
						echo '<table id="datatable-responsive" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="40%" width="100%">
						 <thead>
						<tr>
						<td width="40%"><div align="center"><b>Product Name
						</div></b></td>
						<td width="20%"><div align="center"><b>Size
						</div></b></td>
						<td width="20%"><div align="center"><b>Price
						</div></b></td>
						...
						while($fetchgetproducts = mysqli_fetch_array($rungetproducts, MYSQLI_ASSOC)){
							array_push($prodname, $fetchgetproducts['PRODUCTNAME']);
							array_push($prodid, $fetchgetproducts['PRODUCTID']);
							array_push($prodsize, $fetchgetproducts['SIZE']);
							array_push($prodprice, $fetchgetproducts['PRICE']);
						}
						
						for($index = 0; $index < sizeof($prodname); $index++){
							echo "<tr><td align='center'><a href='ProductDetails.php?PRODID= ".$prodid[$index]."' > ".$prodname[$index]." </a></td>";
							echo "<td align= 'center'>".$prodsize[$index]."</td>";
							echo "<td  style='text-align:right; align:center;' >".$prodprice[$index]."</td></tr>";
						}
