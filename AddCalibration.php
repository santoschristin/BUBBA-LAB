<!DOCTYPE html>
	...
	<!-- START OF PHP -->
		...
		if(isset($_POST['submit'])){
			$_SESSION['newquantity']=$_POST['quantity'];
			header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/AddCalibration2.php");	
		}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-label-left"  >
						...
						while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
							...
							echo"<td align='center'><input type='number' name='quantity[]'/></td></tr>";
							array_push($_SESSION['materialcodearray'], $row['MATERIALCODE']);
							$i++;
						}	
