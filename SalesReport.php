...
session_start(); 
   ...
   header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/SalesReportPDF.php");
				 ...
				 <div align="right">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						<th width="15%"><div align="center"><b>Total Sales
						</div></b></th>
						...
						<td width=\"10%\"><div align=\"center\"><a href='DisplayDailySales.php?DATE={$row['DATE']}' > {$row['DATE']}
						</div></a></td>
