<!DOCTYPE html>
	...
	<!-- START OF PHP -->
		...
		$query1="INSERT INTO REF_CONVERSION (UNIT,VALUE,CONVERTEDUNIT,CONVERTEDVALUE) 
				 VALUES ('{$_POST['unit1']}','{$_POST['value1']}','{$_POST['unit2']}','{$_POST['value2']}')";
		$result1=mysqli_query($dbc,$query1);
		
		$message="Unit: {$_POST['unit1']} converted!";
		}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					...
					<li class="active">Add Conversion</li>
					</ol>
                    </ul>
					 <h3>Conversion Form</h3>	
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-label-left"  >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="value1" size="20" maxlength="30"required="required" class="form-control col-md-7 col-xs-12"/>
                        </div>
                      </div>
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php
								...
								require_once('C:\xampp\htdocs\appdev_mysqlconnect.php');
								$query="select UNIT from REF_UNITS";
								$result=mysqli_query($dbc,$query);
								
								echo '<select name="unit1" class="form-control col-md-7 col-xs-12" placeholder="Choose product size:">';
								echo '<option default>Units</option>';
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Converted Value: 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="value2" size="20" maxlength="30" required="required" class="form-control col-md-7 col-xs-12"/>
                        </div>
                      </div>
					   <div class="form-group">
                        <label for="size" class="control-label col-md-3 col-sm-3 col-xs-12">Unit:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php
								...
								echo '<select name="unit2" class="form-control col-md-7 col-xs-12" placeholder="Choose product size:">';
								echo '<option default>Units</option>';
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
