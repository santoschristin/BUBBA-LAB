...
session_start(); 
   ...
   header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/DiscrepancyReportPDF.php");
                ...
                <div class="x_panel">
				 <div align="right">
                  ...
                  <div class="x_title text-center">
                    ...
                    <h3> INVENTORY DISCREPANCY REPORT
					<br>
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$query=" select c.DATE, m.MATERIALNAME,c.NEWQUANTITY,c.OLDQUANTITY
                                                            from CALIBRATIONS c join MATERIALS m on m.MATERIALCODE=c.MATERIALCODE
								where c.DATE >= {$newDate}
								  OR c.DATE <= {$newDate1}
                                                                  AND m.MATERIALCODE=c.MATERIALCODE";
						...
						<th width="15%"><div align="center"><b>Material Name
						</div></b></th>
						<th width="10%"><div align="center"><b>Old Quantity
						</div></b></th>
						<th width="10%"><div align="center"><b>New Quantity
						</div></b></th>
						<th width="10%"><div align="center"><b>Discrepancy
						</div></b></th>
						</tr>
						</thead>';
						...
						<td width=\"10%\"><div align=\"center\">{$row['OLDQUANTITY']}
						</div></td>
						<td width=\"10%\"><div align=\"center\">{$row['NEWQUANTITY']}
						</div></td>
						<td width=\"10%\"><div align=\"center\">$answer
						</div></td>
						</tr>";
            ...
            $("#datatable-buttons").DataTable({
              ...
              buttons: [
                ...
                },
                {
                  extend: "pdf",
				  className: "btn-sm",
				  title: "Discrepancy Report - BUBBA LAB Food Services",
