              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title text-center">
                    <h3> PURCHASE ORDER <?php echo $_GET["PO"]; ?> DETAILS
					<br>
					<small> as of <?php
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$requestedPO = $_GET["PO"]; //Or do whatever you want
						require_once('C:\xampp\htdocs\appdev_mysqlconnect.php');
						$query="select pod.PURCHASEORDERNO, pod.MATERIALCODE, pod.QTYORDERED, pod.QTYAVAILABLE, pod.UNIT, m.MATERIALCODE, m.MATERIALNAME
