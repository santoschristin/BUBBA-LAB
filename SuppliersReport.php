...
session_start(); 
   ...
   header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/SupplierReportPDF.php");
                ...
                <div class="x_panel">
				 <div align="right">
                  ...
                  <div class="x_title text-center">
                    ...
                    <h3> SUPPLIER TRANSACTION REPORT
					<br>
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo '<table id="datatable-responsive" name="report" class="table btn-sm table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						 <thead>
						<tr>	
						
						<th width="20%"><div align="center"><b>Supplier Name
						</div></b></th>
						<th width="10%"><div align="center"><b>Purchase Order No.
						</div></b></th>
						<th width="15%"><div align="center"><b>Status
						</div></b></th>
						...
						<td width=\"10%\"><div align=\"center\"><a href='DisplaySupplier.php?SUP={$row['SUPPLIERID']}' > {$row['SUPPLIERNAME']}
						</div></a></td>
						<td width=\"10%\"><div align=\"center\"><a href='DisplayPO.php?PO={$row['PURCHASEORDERNO']}' > {$row['PURCHASEORDERNO']}
						</div></a></td>
						
						<td width=\"10%\"><div align=\"center\">{$row['STATUSDESCRIPTION']}
						</div></td>
            ...
            $("#datatable-buttons").DataTable({
              ...
              buttons: [
                ...
                },
                {
                  extend: "pdf",
				  className: "btn-sm",
				  title: "Supplier Transaction Report - BUBBA LAB Food Services",
				...
				// },
				 ...
				 customize: function(document) {
				  document.defaultStyle.fontSize = 30; //<-- set fontsize to 16 instead of 10 
				}  
