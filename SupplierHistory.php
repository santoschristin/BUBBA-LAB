              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="AddNewProduct.html">Add New Product</a></li>
					  <li><a href="AddNewSupplier.html">Add New Supplier</a></li>
					  <li><a href="AddNewMaterial.html">Add New Material</a></li>
					  <li><a href="PurchaseOrderForm.html">Purchase Order Form</a></li>
					  <li><a href="AddConversion.html">Add Conversion </a></li>
					  <li><a href="AddPhysicalCount.html">Add Physical Count for Calibration</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
					  ...
					  <li><a href="SalesReport.html">Sales</a></li>
					  <li><a href="SuppliersReport.html">Suppliers</a></li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr class='clickable-row' data-href='SupplierHistory.php'>
                          <td>Tiger</td>
                          <td>Nixon</td>
