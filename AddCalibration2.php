<!DOCTYPE html>
	...
	<!-- START OF PHP -->
		...
		require_once('C:\xampp\htdocs\appdev_mysqlconnect.php');
			...
			$query="SELECT MATERIALCODE, UNIT, QUANTITYINSTOCK
					  FROM MATERIALS";
			$result=mysqli_query($dbc,$query);
			$i=0;
			while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
						$query2 = "INSERT INTO CALIBRATIONS (NEWQUANTITY, OLDQUANTITY, DATE, MATERIALCODE, UNIT) 
			VALUES ({$NewQuantity[$i]}, {$row['QUANTITYINSTOCK']}, CURDATE(), {$row['MATERIALCODE']}, '{$row['UNIT']}')";
						$result2 = mysqli_query($dbc, $query2) or die ("Error: ".mysqli_error($dbc)) ;
						

						$query3 ="UPDATE MATERIALS
									 SET QUANTITYINSTOCK={$NewQuantity[$i]}
		...
		$message="Quantity of Materials are updated!";
		$flag=1;
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="Dashboard.html" class="site_title"><i class="fa fa-coffee"></i> <span>BUBBA LAB</span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Add Physical Count for Calibration
				<br>
				<small>
						<?php
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					...
					<li><a href="Dashboard.html">Forms</a></li>
					<li class="active">Add Calibration</li>
					</ol>
                    </ul>
					 <h3> </h3>	
                    <div class="clearfix"></div>
				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-label-left"  >
						...
						$query="SELECT MATERIALNAME,QUANTITYINSTOCK, MATERIALCODE
								FROM MATERIALS";
						$result=mysqli_query($dbc,$query);
						$i=0;
						...
						<table id="datatable-responsive" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						 <thead>
						<tr>	
						<th width="5%"><div align="center"><b>Material Name
						</div></b></th>
						<th width="2%"><div align="center"><b>Old Quantity
						</div></b></th>
						<th width="3%"><div align="center"><b>New Quantity
						</div></b></th>
						</tr>
						</thead>';

						$_SESSION['materialcodearray'] = array();
						$NotSoNewQuantity = $_SESSION['newquantity'];
						while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
							if($NotSoNewQuantity[$i]!=null){
								echo"<tr><td  align='center'>".$row['MATERIALNAME']."</td>";
								echo"<td  style='text-align:right'>".$row['QUANTITYINSTOCK']."</td>";
								echo"<td  align='center'>".$NotSoNewQuantity[$i]."</td></tr>";
							}
							$i++;
						}	
