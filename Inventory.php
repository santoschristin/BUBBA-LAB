				 ...
				 <div align="right">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$query="select MATERIALNAME, QUANTITYINSTOCK, UNIT, DESCRIPTION from materials";
						...
						echo '<table id="datatable-responsive" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						 <thead>
						<tr>
						<td width="50%"><div align="center"><b>MATERIAL NAME
						</div></b></td>
						<td width="50%"><div align="center"><b>QUANTITYINSTOCK
						</div></b></td>
						<td width="10%"><div align="center"><b>UNIT
						</div></b></td>
						<td width="5%"><div align="center"><b>DESCRIPTION
						</div></b></td>
						</tr>
						</thead>';
						...
						<td width=\"30%\"><div align=\"center\">{$row['MATERIALNAME']}
						</div></td>
						<td width=\"20%\"><div align=\"center\">{$row['QUANTITYINSTOCK']}
						</div></td>
						<td width=\"20%\"><div align=\"center\">{$row['UNIT']}
						</div></td>
						<td width=\"30%\"><div align=\"center\">{$row['DESCRIPTION']}
						</div></td>
						</tr>";
