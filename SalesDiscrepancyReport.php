...
session_start(); 
	...
	$_POST['newDate'] = $date;
	$_POST['newDate1'] = $date1;
	

   header("Location: http://".$_SERVER['HTTP_HOST'].  dirname($_SERVER['PHP_SELF'])."/SalesDiscrepancyPDF.php");
                ...
                <div class="x_panel">
				 <div align="right">
                  ...
                  <div class="x_title text-center">
                    ...
                    <h3> SALES DISCREPANCY REPORT
					<br>
					<small> from <?php echo " ".$_SESSION["startDate"]." ";?>  to  <?php echo "".$_SESSION["endDate"]." ";?> </small></br>
					</h3>
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$originalDate = $_SESSION["startDate"];
						$newDate = date("Y-m-d", strtotime($originalDate));
						
						$originalDate1 = $_SESSION["endDate"];
						...
						$qgetdiscre = "SELECT * FROM SALESDISCREPANCY 
										WHERE c.DATE >= {$newDate} 
										OR c.DATE <= {$newDate1}";
						$runquery = mysqli_query($dbc, $qgetdiscre);
						...
						<th width="15%"><div align="center"><b>Employee Name
						</div></b></th>
						<th width="15%"><div align="center"><b>Comment
						</div></b></th>
						<th width="10%"><div align="center"><b>Amount
						</div></b></th>
						</tr>
						</thead>';
						
						while($fetchdiscre = mysqli_fetch_array($runquery, MYSQLI_ASSOC)){
							array_push($date, $fetchdiscre['DATE']);
							$employeenum = $fetchdiscre['EMPLOYEENO'];
							$qempname = "SELECT EMPLOYEENAME FROM EMPLOYEES WHERE EMPLOYEENO = '$employeenum'";
							$runqempname = mysqli_query($dbc, $qempname);
							$fetchempname = mysqli_fetch_array($runqempname, MYSQLI_ASSOC);
							array_push($empname, $fetchempname['EMPLOYEENAME']);
							array_push($comment, $fetchdiscre['COMMENT']);
							array_push($amount, $fetchdiscre['AMOUNT']);
						}
						for($index = 0; $index < sizeof($date); $index++){
							echo "<tr><td>".$date[$index]."</td>";
							echo "<td>".$empname[$index]."</td>";
							echo "<td>".$comment[$index]."</td>";
							echo "<td>".$amount[$index]."</td></tr>";
						}
					...
					<button type="submit" name="pdf" class="btn btn-primary pull-left" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</button>
                  </form>
