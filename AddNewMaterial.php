<!DOCTYPE html>
	...
	<!-- START OF PHP -->
		...
		//$query2 = "SELECT MAX(MATERIALCODE) FROM MATERIALS";
		//$result2 = mysqli_query($dbc, $query2);
		//$qgetlastmc = mysqli_fetch_array($result2, MYSQLI_ASSOC);
		//$matcode = $qgetlastmc['MAX(MATERIALCODE)'];
		
		//$qtyIS = $quantity * $value;
				
		///* INSERT INTO INVENTORY */
		//$query="insert into inventory (MATERIALCODE,QUANTITYINSTOCK, UNIT, BRANCHCODE) 
		//values ('{$matcode}','{$qtyIS}','{$units}','1')";
		//$result=mysqli_query($dbc,$query);
		
		
		
		$message="{$materialname} has been added to material list! ";
		$flag=1;
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-label-left"  >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="materialname" size="20" maxlength="30"required="required" class="form-control col-md-7 col-xs-12"
						  value="<?php if (isset($_POST['materialname']) && !$flag) echo $_POST['materialname']; ?>"/>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3  col-xs-9">
                          <input type="number"  name="quantity" size="20" maxlength="30" required="required" class="form-control col-md-7 col-xs-12"
						...
						<div class="col-md-3 col-sm-3 col-xs-9">
                          <?php
								...
								echo '<select name="unit" class="form-control col-md-3 col-xs-9">';
