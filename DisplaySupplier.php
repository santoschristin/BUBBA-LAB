                  ...
                  <div class="x_content">
					...
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal form-label-left"  >
					  ...
					  <?php
						...
						$requestedSUP = $_GET["SUP"]; //Or do whatever you want
						require_once('C:\xampp\htdocs\appdev_mysqlconnect.php');
						$query="select SUPPLIERID, SUPPLIERNAME, DATEADDED, CONTACTPERSON,CELLPHONENUMBER, TELEPHONENUMBER,  EMAILADDRESS, ADDRESS, 2NDADDRESS
								from ref_suppliers
								where  SUPPLIERID = '$requestedSUP'";
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["SUPPLIERNAME"].'</label>
                        </div>
						</div>';
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["ADDRESS"].'</label>
                        </div>
						</div>';
						
						echo'
						 <div class="form-group">
						 <label class="control-label col-md-3 col-sm-3 col-xs-12">Second Address:  
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["2NDADDRESS"].'</label>
                        </div>
						</div>';
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-">'.$row["CONTACTPERSON"].'</label>
                        </div>
						</div>';
						
						echo'
						 <div class="form-group">
						 <label class="control-label col-md-3 col-sm-3 col-xs-12">Cellphone Number:  
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["CELLPHONENUMBER"].'</label>
                        </div>
						</div>';
						
						echo'
						 <div class="form-group">
						 <label class="control-label col-md-3 col-sm-3 col-xs-12">Telephone Number:  
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["TELEPHONENUMBER"].'</label>
                        </div>
						</div>';
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["EMAILADDRESS"].'</label>
                        </div>
						</div>';
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 <label class="control-label col-md-6 col-sm-6 col-xs-12">'.$row["DATEADDED"].'</label>
                        </div>
						</div>';
						...
						<?php
						$requestedSUP = $_GET["SUP"];
						
						$query1="select pod.PURCHASEORDERNO,po.DATE,po.STATUSCODE, po.PURCHASEORDERNO, m.MATERIALCODE, pod.MATERIALCODE, rs.SUPPLIERID, m.SUPPLIERID, rs.SUPPLIERNAME, m.MATERIALNAME,
										m.QUANTITYINSTOCK, m.UNIT, pod.QTYAVAILABLE
								...
								where  m.SUPPLIERID = '$requestedSUP'
								";
						...
						<table id="datatable-responsive" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						 <thead>
						<tr>	
						<th width="20%"><div align="center"><b>Purchase Order No.
						</div></b></th>
						<th width="15%"><div align="center"><b>Date
						</div></b></th>
						<th width="10%"><div align="center"><b>Material Name
						</div></b></th>
						<th width="15%"><div align="center"><b>Quantity
						</div></b></th>
						
						<th width="10%"><div align="center"><b>Unit
						</div></b></th>
						...
						echo "<tr>
						<td width=\"15%\"><div align=\"center\">{$row['PURCHASEORDERNO']}
						</div></td>
						<td width=\"15%\"><div align=\"center\">{$row['DATE']}
						</div></td>
						<td width=\"20%\"><div align=\"center\">{$row['MATERIALNAME']}
						</div></td>
						<td width=\"20%\"><div align=\"center\">{$row['QTYAVAILABLE']}
						</div></td>
